...
<body>
  ...
  <header id="header" class="fixed-top" data-aos="fade-up">
    <div class="container d-flex align-items-center justify-content-between">
      <a href="index.html" class="logo"><img src="https://www.sfait.net/assets/img/le-monde-de-la-glisse/logo.png" alt="" class="img-fluid"></a>
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a class="nav-link scrollto" href="weather.php">Météo</a></li>
          <li><a class="nav-link scrollto" href="#contact">Contact</a></li>
          <li><a class="getstarted scrollto" href="#"><i class="fs-5 bi bi-person-circle" style="margin: 0;"></i><span class="connect-button">Se connecter</span></a></li>
